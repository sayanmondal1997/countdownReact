...
//   const handleClick = () => history.push('/goodbye');
  ...
  return (
    <div className="App">
      ...
      {clicked ? <Countdown  countDownStyle={{count: {y: true, m: true, d: true, h: true, min: true, s: true}, eventName: 'Event', eventDate: '10/07/2020', background: 'yellow', textStyle: {headercolor: 'black', timeleftColor: 'black', headerSize: '20px', timeleftSize: '25px', fontFamily: 'fantasy'}, borderradius: '10px'}} ></Countdown> : null}
    </div>
  );
}
